...
<div class="container mt-5">
    ...
    <c:if test="${not empty candidatures}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="admin" method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="statut${candidature.id}" class="form-label">Nouveau Statut</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="commentaire${candidature.id}" class="form-label">Commentaire (optionnel)</label>
        ...
        </div> <!-- Closing the table-responsive div -->
    </c:if> <!-- Closing the c:if condition for candidatures -->
